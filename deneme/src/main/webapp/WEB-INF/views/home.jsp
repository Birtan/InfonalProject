									...
									"Create an account" : function() {
										...
										function ajax(){
											...
											$.ajax({
												...
												data : {"name":name,"email":email,"telefon":telefon},// gönderilecek bilgiler bu alanda belirtilir
												type : "GET",
												async : false,
												contentType: "application/json",
												success: function(bilgi){ // geri dönen sonuç
													alert();
													$("#gif").show("slow");
													}
												});
...
<body>
	<div id="dialog-form" title="Create new user">
		...
		<form>
			<fieldset>
				...
				<label for="password">Phone</label> <input type="password"
					name="telefon" id="password" value=""
		...
		<table id="users" class="ui-widget ui-widget-content">
			...
			<tbody>
				...
				<tr>
					...
					<td>mail:${kullanicilar.soyad}</td>
					<td>telefon:${kullanicilar.mail}</td>
					</tr>
				</c:forEach>
    ...
    <img src="././resources/img/loading-page.gif" id="gif" width="100" height="100" style="display:none">
</body>
